...
// Ma'lumotlar shu fayl ichida kiritilgan
const hero = {
  title: "Men haqimda",
  descrription: "Salom! Men Zayniyev Ulug'bekman — web dasturchiman. ReactJS, TailwindCSS va Three.js asosida chiroyli, tezkor, va mobilga mos saytlar ishlab chiqaman. Mening maqsadim — foydalanuvchilarni hayratlantiradigan interfeyslar yaratish.",
};
...
const services = [
  {
    ...
    icon: "/assets/web.svg",
    description: "Har qanday ekran o‘lchamiga mos, chiroyli va tez ishlovchi web saytlar ishlab chiqaman.",
  },
  {
    title: "3D Web Ilovalar",
    icon: "/assets/3d.svg",
    description: "Three.js va WebGL orqali foydalanuvchini o‘ziga tortuvchi 3D sahifalar yarataman.",
  },
  {
    title: "Frontend Dasturlash",
    icon: "/assets/frontend.svg",
    description: "ReactJS va TailwindCSS asosida kuchli va tezkor foydalanuvchi interfeyslari yarataman.",
  },
];
...
const projects = [
  {
    ...
    description:
      "Mening shaxsiy portfoliyam: men haqimda, loyihalarim, aloqa formasi va 3D animatsiyalar mavjud.",
  ...
  },
  {
    ...
    description:
      "'Start Space' tugmasi orqali foydalanuvchini 3D kosmik interfeysga olib kiruvchi sahifa.",
    tags: ["Three.js", "WebGL"],
...
const Hero = () => (
  <section id="about" className="py-20 px-6 bg-white dark:bg-gray-900">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <p className="text-lg text-gray-700 dark:text-gray-300">{hero.descrription}</p>
    </div>
  </section>
);
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {projects.map((project, index) => (
          <div key={index} className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow">
            ...
            <a href={project.
            source_code_link} target="_blank" rel="noopener noreferrer" className="inline-block mt-4 text-blue-600 hover:underline">
              Kodni ko‘rish →
            </a>
          </div>
        ))}
  ...
  <section id="contact" className="py-16 px-6 bg-gray-100 dark:bg-gray-900">
    <div className="max-w-xl mx-auto text-center">
      ...
      <form className="flex flex-col gap-4">
        ...
        <button type="submit" className="bg-blue-600 text-white py-3 rounded hover:bg-blue-700 transition">Yuborish</button>
      </form>
